...
object ClozapineSeed {
    ...
    val drug: Drug = Drug(
        ...
        cypProfile = CypProfile(
            substrates = listOf(
                CypContribution(catalog.CypEnzyme.CYP1A2, 0.70),
                CypContribution(catalog.CypEnzyme.CYP3A4, 0.20),
                CypContribution(catalog.CypEnzyme.CYP2C19, 0.10)
            ),
